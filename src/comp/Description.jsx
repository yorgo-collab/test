...
const Description = ({addListing,handleAddListing,handleCategory,handleAdType}) => {

  return (
    <div className='content'>
        <Content className='d-flex align-items-center justify-content-between w-100 flex-wrap'>
            <FormGroup>
            <label className='w-100 d-inline-block fw-bolder ' >Property Title <span>(required)</span></label>
...
{addListing.addescription=='Rental' &&(
  <FormGroup style={{marginBottom:'auto'}}>
    ...
    <option className='p-2 text-capitalize '>yearly</option>
            ...
            <FormGroup>
            <label className='w-100 d-inline-block fw-bolder ' >Description <span>(required)</span></label>  
