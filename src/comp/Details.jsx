...
`
const Details = ({addListing,handleAddListing}) => {
  return (
    <div className='m-1'>
        <Content className='d-flex justify-content-between align-items-center flex-wrap w-100'>
           ...
           <FormGroup>
            ...
            <FormGroup>
            <label className='w-100 d-inline-block fw-bolder' >floor</label>
            ...
            <FormGroup>
                <label className='w-100 d-inline-block fw-bolder'  htmlFor='furnished'>furnished</label>
...
<div className="form-check form-check-inline">
  ...
  <label className="form-check-label" for="inlineRadio2">no</label>
            ...
            <FormGroup>
            <label className='w-100 d-inline-block fw-bolder' >size</label>
            ...
            <FormGroup>
                <label className='w-100 d-inline-block fw-bolder' >Payment method</label>
                <div className="form-check form-check-inline">
