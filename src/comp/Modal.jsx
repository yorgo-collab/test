...
const Signup =()=>{
    ...
    <form onSubmit={(e)=>{onSubmit(e);setsignupData({['name']:'',['email']:'',['password']:''})}}>
    <DialogContent>
    <Box noValidate component="form"
          sx={{display: 'flex', flexDirection: 'column',  m: 'auto', width: 350, }}>
    ...
    <DialogContentText>
      <p className="fs-6 text-dark ms-1" >Already have an account? <span onClick={()=>seSection('login')}className="text-primary fs-6">login</span></p> 
      </DialogContentText>   
      </>)
}
  return createPortal(
